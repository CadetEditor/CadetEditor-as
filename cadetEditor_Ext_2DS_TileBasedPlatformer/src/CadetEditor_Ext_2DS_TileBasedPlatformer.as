package
{
	...
	public class CadetEditor_Ext_2DS_TileBasedPlatformer extends Sprite
	{
		public function CadetEditor_Ext_2DS_TileBasedPlatformer()
		{
...
//			resourceManager.addResource( new ComponentFactory( CollisionDetectionProcess, 	"Collision Detection", 			"Processes", 	CadetEngineIcons.Process, 		ICadetScene, 	1, null, CadetEditorContext2D ) );
			...
			resourceManager.addResource( new ComponentFactory( GridProcess, 				"Grid Process", 				"Processes", 	CadetEngineIcons.Process, 		ICadetScene, 	1, null, CadetEditorContext2D ) );
			...
			// Skins
			resourceManager.addResource( new ComponentFactory( ImageSkin, 					"Image Skin", 					"Skins", 		CadetEngineIcons.Skin, 			Entity, 		1, null, CadetEditorContext2D ) );
				
			// Behaviours
			resourceManager.addResource( new ComponentFactory( TileBehaviour, 				"Tile Behaviour", 				"Behaviours", 	CadetEngineIcons.Behaviour, 	Entity, 		1, null, CadetEditorContext2D ) );
			resourceManager.addResource( new ComponentFactory( ProtagonistEntity, 			"Protagonist Entity", 			"Behaviours", 	CadetEngineIcons.Behaviour,		Entity, 		1, null, CadetEditorContext2D ) );
			resourceManager.addResource( new ComponentFactory( EntityUserControlBehaviour, 	"Entity User Control", 			"Behaviours", 	CadetEngineIcons.Behaviour,		Entity, 		1, null, CadetEditorContext2D ) );
