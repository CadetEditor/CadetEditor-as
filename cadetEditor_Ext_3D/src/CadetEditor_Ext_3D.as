...
/*			if ( FloxEditor.environment == FloxEditorEnvironment.AIR )
			...
			// Entities =======================================
			// Behaviours
			resourceManager.addResource( new ComponentFactory( RigidBodyBehaviour, "Rigid Body", "Behaviours", CadetEngineIcons.Behaviour, MeshComponent, 1, null, CadetEditorContext3D ) );	
			// Cameras
...
//			resourceManager.addResource( new ComponentFactory( HeightmapGeometryComponent, "HeightmapGeometry", "Geometry", CadetBuilderAway3D4Icons.Geometry, null, -1, null, CadetEditorContextAway3D4 ) );
			...
			// Processes ======================================
			resourceManager.addResource( new ComponentFactory( HoverCamProcess, "HoverCamProcess", "Processes", CadetEngineIcons.Process, ICadetScene, 1, null, CadetEditorContext3D ) );
			...
			resourceManager.addResource( new ComponentFactory( PhysicsProcess, "Physics Process", "Processes", CadetEngineIcons.Process, ICadetScene, 1, null, CadetEditorContext3D ) );	
			
			// Textures =======================================
			resourceManager.addResource( new ComponentFactory( BitmapTextureComponent, "Bitmap Texture", "Textures", CadetEngineIcons.Texture, null, -1, null, CadetEditorContext3D ) );
			resourceManager.addResource( new ComponentFactory( BitmapCubeTextureComponent, "Bitmap Cube Texture", "Textures", CadetEngineIcons.Texture, null, -1, null, CadetEditorContext3D ) );
